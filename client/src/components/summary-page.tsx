...
import { ChevronLeft, Edit, Send, FileText } from "lucide-react";
...
export default function SummaryPage({ formData, onEdit, onPrev }: SummaryPageProps) {
  ...
  const submitMutation = useMutation({
    mutationFn: async () => {
      ...
      return apiRequest("POST", "/api/insurance-applications", applicationData);
    },
    onSuccess: () => {
      toast({
        title: "Application Submitted",
        description: "Your insurance application has been successfully submitted. You will receive a confirmation email shortly.",
      });
    },
    onError: (error) => {
      toast({
        ...
        <div className="flex justify-between items-center mt-8 pt-6 border-t border-gray-200">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Button
              ...
              disabled={!consent || !hipaaConsent || submitMutation.isPending}
